  ...
  return (
    <div style={{ minHeight:'100vh', background:'#F8FAFC' }}>
      ...
      <div style={{ maxWidth:800, margin:'0 auto', padding:'40px 24px' }}>
        <h1 style={{ fontFamily:'Poppins,sans-serif', fontWeight:900, color:'#1E3A5F', fontSize:32, marginBottom:4 }}>Terms & Conditions</h1>
        <p style={{ color:'#94A3B8', fontSize:13, marginBottom:32 }}>Last updated: June 2026</p>
        <div style={{ display:'flex', flexDirection:'column', gap:4, background:'#fff', borderRadius:16, padding:16, border:'1.5px solid #E2E8F0', marginBottom:32 }}>
          <p style={{ fontWeight:700, color:'#1E3A5F', fontSize:13, marginBottom:8 }}>Table of Contents</p>
          {SECTIONS.map(s=>(
        ...
        {SECTIONS.map(s=>(
          <div key={s.num} id={`s${s.num}`} style={{ marginBottom:28 }}>
            <h2 style={{ fontFamily:'Poppins,sans-serif', fontWeight:800, color:'#1E3A5F', fontSize:18, marginBottom:8 }}>{s.num}. {s.title}</h2>
