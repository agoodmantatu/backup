  ...
  return (
    <div style={{minHeight:'100vh',background:bg,fontFamily:'Poppins,sans-serif'}}>
      <div style={{background:c,borderBottom:`1px solid ${b}`,padding:'16px 20px',
        ...
        <button onClick={()=>nav('/student/hall')} style={{background:`linear-gradient(135deg,${p},${a})`,
      ...
      <div style={{padding:'20px',maxWidth:760,margin:'0 auto'}}>
        ...
        <div style={{background:`linear-gradient(135deg,${p},${p}cc)`,borderRadius:18,
          ...
          <button onClick={()=>nav('/student/hall')} style={{background:`linear-gradient(135deg,${a},#E8C44A)`,
        ...
        {HALLS.map((h,i)=>(
          <div key={i} onClick={()=>nav('/student/hall')}
            ...
            <button onClick={e=>{e.stopPropagation();nav('/student/hall')}}
