    ...
    <div style={{ minHeight:'100vh', background:bg, fontFamily:'Inter,sans-serif' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ color:muted, fontSize:11, margin:0 }}>Subject-wise performance and weak topic alerts</p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color:muted, fontSize:14, margin:'0 0 24px', lineHeight:1.7 }}>
            Subject-wise performance and weak topic alerts.<br/>This section is being built and will be live soon.
          </p>
