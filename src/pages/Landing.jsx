    ...
    <section style={{ background:'linear-gradient(135deg, var(--color-primary-dark, #1E3A5F), var(--color-primary, #0F2140))', padding:'32px 20px' }}>
      <div style={{ maxWidth:1200, margin:'0 auto', display:'flex',
        ...
        <div ref={r1} style={{ flex:'1 1 180px', textAlign:'center',
          ...
          <p style={{ color:'rgba(255,255,255,0.72)', fontSize:13, marginTop:4 }}>Exam Pathways</p>
        </div>
        <div ref={r2} style={{ flex:'1 1 180px', textAlign:'center',
          ...
          <p style={{ color:'rgba(255,255,255,0.72)', fontSize:13, marginTop:4 }}>Indian Languages</p>
        </div>
        <div style={{ flex:'1 1 220px', textAlign:'center',
          ...
          <p style={{ color:'rgba(255,255,255,0.72)', fontSize:13, marginTop:4, fontStyle:'italic' }}>
            What about YOU? 🔥
          </p>
        </div>
        <div style={{ flex:'1 1 260px', textAlign:'center',
          ...
          <p style={{ color:'rgba(255,255,255,0.72)', fontSize:11, marginTop:4 }}>
        ...
        <div style={{ flex:'1 1 160px', textAlign:'center',
          ...
          <p style={{ color:'rgba(255,255,255,0.72)', fontSize:13, marginTop:4 }}>States Covered</p>
        </div>
      </div>
    </section>
  )
...
function TestPreview() {
  ...
  return (
    <section id="student" style={{ padding:'72px 20px', background:'var(--color-bg, #F8FAFC)' }}>
          ...
          <div style={{ padding:'24px 20px' }}>
            ...
            <div style={{ display:'flex', gap:10, marginTop:20, flexWrap:'wrap' }}>
              ...
              {revealed && (
                <button onClick={() => { setSelected(null); setRevealed(false) }} style={{
                  ...
                  fontWeight:700, fontSize:14, color:'#FFFFFF', cursor:'pointer' }}>
                  Try Again
                </button>
              )}
            </div>
            {revealed && (
              <div style={{ marginTop:16, background:'rgba(34,197,94,0.12)',
                ...
                <p style={{ color:'#15803D', fontSize:11, marginTop:8, fontStyle:'italic', opacity:0.7 }}>
                  + 6 more layers (deep concept, wrong option autopsy, cultural story, exam tip,
                  PYQ relevance) — available in 42 languages after login
                </p>
              </div>
            )}
          </div>
            ...
            <div key={i} style={{ padding:'13px 20px',
              ...
              <div>
                <div style={{ display:'flex', alignItems:'center', gap:6, flexWrap:'wrap' }}>
                  <span style={{ color:'#FFFFFF', fontWeight:600, fontSize:13 }}>{r.name}</span>
              ...
              <span style={{ background:'rgba(255,255,255,0.08)', color:'rgba(255,255,255,0.72)',
...
function FeaturesGrid({ navigate }) {
  const FEATURES = [
    ...
    { emoji:'🌌', title:'Exam Universe',           sub:'UPSC · JEE · NEET · CLAT · Foreign',  badge:'110,000+'  },
    ...
    { emoji:'🎮', title:'Brain Games',             sub:'24 games · Coins · Tournaments',       badge:'Fun'       },
    ...
    { emoji:'🌐', title:'42+ Languages',           sub:'Tamil · Hindi · Telugu · NE · More',   badge:'Inclusive' },
    { emoji:'🎯', title:'Focus Mode',             sub:'Pomodoro · Ambient sounds · Coins',    badge:'Study'     },
    { emoji:'🤝', title:'Free for 6 Tiers',       sub:'Orphans · Veer Naris · Trans · More',  badge:'Equity'    },
  ]
  return (
    <section style={{ padding:'72px 20px', background:'var(--color-bg,#F8FAFC)' }}>
      <div style={{ maxWidth:1100, margin:'0 auto' }}>
        ...
        <div style={{ display:'grid',
          gridTemplateColumns:'repeat(auto-fill,minmax(min(100%,240px),1fr))', gap:14 }}>
          {FEATURES.map((f, i) => (
            <div key={i} onClick={() => navigate('/login')}
              ...
              <div style={{ display:'flex', justifyContent:'space-between',
                ...
                <span style={{ background:'var(--color-surface,#F8FAFC)',
...
// ── MENTOR SECTION ANCHOR ─────────────────────────────────────────
// Gives the Navbar "Mentor" tab something to scroll to.
// InstitutionSection already has rich content so we anchor there too.
function MentorAnchor() {
  return (
    <div id="mentor" style={{ scrollMarginTop:80 }}>
...
function EquitySection({ navigate }) {
  ...
  return (
    <section id="family" style={{ padding:'72px 20px',
      ...
      <div style={{ maxWidth:1000, margin:'0 auto' }}>
        <div style={{ textAlign:'center', marginBottom:36 }}>
          ...
          <h2 style={{ fontFamily:'Poppins,sans-serif', fontWeight:900,
            fontSize:'clamp(24px,4vw,40px)', color:'#FFFFFF', margin:'12px 0 8px' }}>
            TryIT Fellowship — Free For Life
          </h2>
          <p style={{ color:'rgba(255,255,255,0.74)', fontSize:15,
            maxWidth:560, margin:'0 auto 8px' }}>
            6 communities get 100% free access for life. One subscription funds another student.
          </p>
        </div>
        <div style={{ display:'grid',
          ...
          {TIERS.map((t, i) => (
            <div key={i} style={{ background:'rgba(255,255,255,0.04)',
              ...
              <span style={{ color:'#FFFFFF', fontFamily:'Poppins,sans-serif',
...
function Testimonials() {
  const ITEMS = [
    ...
    { n:'Priya S.',  s:'Kerala',  e:'NEET UG',  r:'#847',    sc:'94%', t:'"Studied in Malayalam. Crystal clear!" 🌴',                        lv:'💪 Grinder'    },
    { n:'Rahul M.',  s:'Bihar',   e:'UPSC CSE', r:'#2,341',  sc:'82%', t:'"Career Compass told me UPSC + BPSC. Best decision!" 🎯',          lv:'📈 Riser'      },
    { n:'Zainab A.', s:'Hyd',     e:'IBPS PO',  r:'#519',    sc:'91%', t:'"Guru Hub answered my doubt at midnight in 7 minutes!" 🎓',        lv:'🦁 Baahuveer'  },
    { n:'Deepika R.',s:'Manipur', e:'CTET',     r:'#1,021',  sc:'87%', t:'"First platform with Manipuri language. Thank you TryIT!" 🏔️',    lv:'📈 Riser'      },
    ...
    <section style={{ padding:'72px 20px',
      ...
      <div style={{ maxWidth:700, margin:'0 auto' }}>
        ...
        <p style={{ color:'rgba(255,255,255,0.65)', fontSize:16,
          ...
          1,10,000+ exams. 42+ languages. Real rankings. Free for 6 communities.
...
export default function Landing() {
  ...
  // Hash anchor scroll — runs once when location.hash changes
  useEffect(() => {
  ...
  return (
    <div>
      ...
      {/* Hero — 3 rotating scripts with animations */}
      <Hero/>

      {/* Stats */}
      <StatsStrip/>

      {/* Student section anchor → Test Engine + Features */}
      <TestPreview/>
      ...
      {/* Mentor section anchor → Equity Pricing */}
      <div id="mentor" style={{ scrollMarginTop:80 }}>
        <EquityPricingSection/>
      </div>

      {/* Institution section anchor */}
      <div id="institution" style={{ scrollMarginTop:80 }}>
        <InstitutionSection/>
      </div>

      {/* Family / Equity section anchor */}
