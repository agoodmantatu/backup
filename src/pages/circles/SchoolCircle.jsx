  ...
  return (
    <AppLayout title="School Circle">
      <div className="max-w-2xl mx-auto space-y-6 p-4">
        ...
        <div className="bg-gradient-to-r from-[#1E3A5F] to-[#3B2A6B] rounded-2xl p-5 text-white">
        ...
        {hasCircle ? (
          <>
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center justify-between">
              <div>
                ...
                <p className="font-mono font-black text-[#D4AF37] text-xl">{user.institutionCode || codeInput.toUpperCase()}</p>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
              <h2 className="font-bold text-[#1E3A5F] mb-3">Members ({SAMPLE_MEMBERS.length})</h2>
              <div className="flex flex-wrap gap-2">
                {SAMPLE_MEMBERS.map(m => (
                  <div key={m.name} className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2">
                    <div className="w-7 h-7 rounded-full bg-[#1E3A5F] text-white text-xs font-bold flex items-center justify-center">{m.initials}</div>
                    <div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
              <div className="p-5 border-b border-gray-100">
                <h2 className="font-bold text-[#1E3A5F]">Announcements</h2>
              </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 text-center space-y-4">
            ...
            <p className="font-bold text-[#1E3A5F] text-lg">Join a School Circle</p>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-gray-200 rounded-xl px-4 py-2 text-sm font-mono uppercase focus:outline-none focus:ring-2 focus:ring-[#D4AF37]"
              />
              <button
                onClick={handleJoin}
